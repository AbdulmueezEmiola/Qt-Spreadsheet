...
void MainWindow::sort()
{
    ...
    if (dialog.exec()) {
        ...
        compare.keys[0] =
              dialog.getIndexPrimary();
        compare.keys[1] =
              dialog.getIndexSecondary();
        compare.keys[2] =
              dialog.getIndexTertiary();
        compare.ascending[0] =(dialog.getIndexOrderPrimary() == 0);
        compare.ascending[1] =
              (dialog.getIndexOrderSecondary() == 0);
        compare.ascending[2] = (dialog.getIndexOrderTertiary() == 0);
